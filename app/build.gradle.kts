...
abstract class ExportReleaseToDesktopTask : DefaultTask() {
  ...
  fun export() {
    ...
    val baseName = "DaddyHeartJournal-v${versionName.get()}-vc${versionCode.get()}"
...
android {
  namespace = "com.jeiel.daddyheartjournal"
  compileSdk { version = release(36) { minorApiLevel = 1 } }

  defaultConfig {
    applicationId = "com.jeiel.daddyheartjournal"
    minSdk = 24
    targetSdk = 36
    versionCode = 1
    versionName = "1.0.0"
  ...
  signingConfigs {
    create("release") {
      val keystorePath = signingValue("KEYSTORE_PATH", "keystorePath")
        ?: "${rootDir}/.keystore/daddy-heart-journal-upload.jks"
